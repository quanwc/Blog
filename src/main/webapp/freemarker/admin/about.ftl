...
<link rel="stylesheet" href="/css/bootstrap-tagsinput.min.css" >
...
<!--     <link href="https://cdn.bootcss.com/morris.js/0.4.3/morris.css" rel="stylesheet"> -->
</head>
<body>
...
// 					alert(tagsStr);
					$("#blogForm").attr('action','/admin/aboutUpdate').submit();
				})
            });
        </script>
